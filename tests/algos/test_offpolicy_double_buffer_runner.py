...
def test_sac_cuda_graph_critic_override_is_passed_to_learner(
    monkeypatch: pytest.MonkeyPatch,
):
    import gymnasium as gym
    ...
    assert runner.kwargs["learner"].kwargs["use_cuda_graph_critic"] is True


def test_sac_cuda_graph_actor_override_is_passed_to_learner(
    monkeypatch: pytest.MonkeyPatch,
):
    import gymnasium as gym
